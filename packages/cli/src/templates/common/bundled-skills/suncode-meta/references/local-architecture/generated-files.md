...
When an AI customizes local Suncode files, it does not need to maintain hashes manually. It is normal for Suncode update to recognize the result as "modified by the user."
