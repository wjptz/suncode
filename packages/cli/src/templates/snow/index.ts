 ...
 * - Slash commands under `.snow/commands/suncode-*.json` (prompt type)
 ...
 * context, so suncode-start is filtered out of skills/commands (optional
 ...
 * suncode-research remains standalone (no implement/check-specific prelude).
 */
