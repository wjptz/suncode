...
Often the user does not need to change Suncode mechanics; they need local AI to understand their team's conventions. In that case, prefer `.trellis/spec/` or a project-local skill instead of editing `suncode-meta`.
