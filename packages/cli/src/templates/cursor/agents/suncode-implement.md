...
description: Suncode implementation agent. Use this exact agent for Suncode task implementation, implement.jsonl context injection, and hook-injection tests. Do not use generic/default/generalPurpose agents for Suncode implementation. No git commit allowed.
