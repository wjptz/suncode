---
name: suncode-check
description: Suncode quality check agent. Use this exact agent for Suncode task verification, check.jsonl context injection, and self-fixing code review. Do not use generic/default/generalPurpose agents for Suncode checks.
