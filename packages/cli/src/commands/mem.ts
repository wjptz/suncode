/**
 * mem.ts — CLI wrapper over `@wjptz/suncode-core/mem`.
 *
 ...
 *
 * Run `suncode mem help` for the full flag reference.
 */
...
function warnOpencodeUnavailable(): void {
  ...
  process.stderr.write(
    "⚠️  suncode mem: OpenCode platform reader is temporarily unavailable in this build.\n" +
...
examples:
  suncode mem list
  suncode mem list --global --platform claude --since 2026-04-01
  suncode mem search "session insight" --global
  suncode mem extract 5842592d --grep memory
