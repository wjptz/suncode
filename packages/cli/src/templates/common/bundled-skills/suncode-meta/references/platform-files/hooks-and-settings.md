...
Hooks/settings are the entry layer that connects a platform to Suncode. They decide which scripts, plugins, or extensions a platform runs for which events.
...
If the user says "AI did not read Suncode state":
