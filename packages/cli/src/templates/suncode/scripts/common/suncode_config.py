#!/usr/bin/env python3
"""
Standalone reader for .suncode/config.yaml.
...
CONFIG_REL_PATH = ".suncode/config.yaml"
...
def read_suncode_config(repo_root: Optional[Path] = None) -> dict:
    """Read .suncode/config.yaml. Returns {} on missing or malformed file."""
