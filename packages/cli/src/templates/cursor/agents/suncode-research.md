...
description: Suncode research agent. Use this exact agent for Suncode task research and research/ persistence. Do not use generic/default/generalPurpose agents for Suncode research.
